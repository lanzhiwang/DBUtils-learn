...
if __name__ == '__main__':
    ...
    self._maxcached: 1
    self._maxshared: 1
    self._shared_cache: [<__main__.SharedDBConnection object at 0x10e1d7f98>]
    self._maxconnections: 0
    self._idle_cache: []
    self._connections: 1
    """
    ...
    self._maxcached: 1
    self._maxshared: 1
    self._shared_cache: [<__main__.SharedDBConnection object at 0x100dfbf98>]
    self._maxconnections: 0
    self._idle_cache: [<SteadyDB.SteadyDBConnection object at 0x100e0a080>]
    self._connections: 1
    """
    ...
    self._maxcached: 2
    self._maxshared: 2
    self._shared_cache: [<__main__.SharedDBConnection object at 0x10e1d0f60>, <__main__.SharedDBConnection object at 0x10e1df080>]
    self._maxconnections: 0
    self._idle_cache: []
    self._connections: 2
    """
    print(db2._con is not db1._con)  # True
    db2.close()
    # db2 = pool.connection()
